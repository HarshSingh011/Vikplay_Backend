...
from streaming.models import Stream, ChatMessage
from streaming.schemas import StreamCreate, Stream as StreamResponse, StreamPublic, ChatMessage as ChatMessageResponse
from streaming.utils.websocket import ConnectionManager
...
@router.get("/streams", response_model=List[StreamPublic])
...
@router.get("/streams/{stream_id}", response_model=StreamPublic)
